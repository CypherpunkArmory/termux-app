...
final class TermuxInstaller {
    ...
    static void setupIfNeeded(final Activity activity, final Runnable whenDone) {
        ...
        final File PREFIX_FILE = new File(TermuxService.prefixPath);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    final String STAGING_PREFIX_PATH = TermuxService.filesPath + "/usr-staging";
    ...
    static void setupStorageSymlinks(final Context context) {
        ...
        new Thread() {
            public void run() {
                try {
                    File storageDir = new File(TermuxService.homePath, "storage");
